...
const IncentiveSection = () => {
  return (
    <div className="bg-blue-500 mx-5 mb-10 text-white flex justify-center items-center p-8 rounded-lg mt-10">
      <div className="flex flex-wrap gap-10 items-center incentiveBottomSection justify-center">
        ...
        <div className="col-span-4 text-center mt-6 bg-white p-2 rounded-lg text-black">
